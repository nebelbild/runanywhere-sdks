...
typedef struct rac_diffusion_model_strategy {
    ...
    rac_result_t (*load_model)(const char* model_path, const rac_diffusion_model_def_t* model_def,
                               rac_handle_t* out_service, void* user_data);
...
rac_diffusion_model_registry_register(const rac_diffusion_model_strategy_t* strategy);
